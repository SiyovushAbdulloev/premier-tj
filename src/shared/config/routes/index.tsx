...
export const RoutesPath: Record<AppRoutes, string> = {
    ...
    [AppRoutes.ADMIN_MOVIES_EDIT]: '/admin/movies/:slug/edit',
    [AppRoutes.ADMIN_MULTIMEDIAS]: '/admin/multimedias',
    [AppRoutes.ADMIN_MULTIMEDIAS_CREATE]: '/admin/multimedias/create',
    [AppRoutes.ADMIN_MULTIMEDIAS_EDIT]: '/admin/multimedias/:slug/edit',
    [AppRoutes.ADMIN_SERIES]: '/admin/series',
    [AppRoutes.ADMIN_SERIES_CREATE]: '/admin/series/create',
    [AppRoutes.ADMIN_SERIES_EDIT]: '/admin/series/:slug/edit',
    [AppRoutes.ADMIN_SERIE_SEASONS]: '/admin/series/:slug/serie-seasons',
    [AppRoutes.ADMIN_SERIE_SEASONS_CREATE]: '/admin/series/:slug/serie-seasons/create',
    [AppRoutes.ADMIN_SERIE_SEASONS_EDIT]: '/admin/series/:slug/serie-seasons/:seasonId/edit',
    [AppRoutes.ADMIN_SERIE_SEASON_EPISODES]: '/admin/series/:slug/serie-seasons/:seasonId/season-episodes',
    [AppRoutes.ADMIN_SERIE_SEASON_EPISODES_CREATE]: '/admin/series/:slug/serie-seasons/:seasonId/season-episodes/create',
    [AppRoutes.ADMIN_SERIE_SEASON_EPISODES_EDIT]: '/admin/series/:slug/serie-seasons/:seasonId/season-episodes/:episodeId/edit',
    ...
    [AppRoutes.SERIES_SHOW]: '/series/:slug/show',
    [AppRoutes.FREE_MEDIA]: '/free',
    [AppRoutes.MULTIMEDIAS_SHOW]: '/shows/:slug/show',
